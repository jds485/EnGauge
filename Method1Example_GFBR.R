#Example of using the EnGauge repository functions
#Applied in the Gwynns Falls and Baisman Run watersheds in Maryland.
...
legend('bottomleft', title = 'Streamflow Stations', legend = c('Zeros in Record', 'Negatives in Record', 'Both', 'Neither'), pch = 16, col = c('red', 'blue', 'purple', 'black'), bty = 'n')
dev.off()
...
legend('bottomleft', title = 'Water Quality Sites', legend = c('T Nitrogen Only', 'T Phosphorus Only', 'Both'), col = c('red', 'blue', 'purple'), pch = 16)
dev.off()
